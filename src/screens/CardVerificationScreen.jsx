...
const CardVerificationScreen = ({ card, onVerified, onBack, darkMode = false }) => {
  ...
  if (verificationStep === 1) {
    return (
      <div className={`min-h-screen  pb-8 flex flex-col items-center justify-center p-6 ${bgClass} animate-in fade-in`}>
