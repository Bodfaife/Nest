...
export default function LoanDetailModal({ selectedLoan, setModal, loans, setLoans, savingsBalance, setSavingsBalance, handleTransactionAdd }) {
    ...
    <div className="absolute inset-0 bg-white p-6 z-30 overflow-y-auto">
      ...
      <button onClick={()=>{
        if(repayAmount>0 && repayAmount<=remaining){
          ...
          setSavingsBalance((savingsBalance || 0) - repayAmount);
